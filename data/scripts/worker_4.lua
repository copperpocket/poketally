            ...
            function checkEncounter()
                ...
                if species > 0 and species < 412 then
                    if species ~= last_species then
                        ...
                        local f = io.open("/home/michael/Projects/gamedev/pokemon/poketally/data/bridge/found_4.txt", "w")
                        if f then 
